...
vector<string> ReadInfoFromFile()
...

{
...

  {
    ...
    vector<string> Slines = ReadInfoFromFile();
...

    {
...

      {
...

        {
          ...
          string S2 = Data.AccountData + "#//#" + NewData.Number + "#//#" + NewData.Name + "#//#" + NewData.Phone + "#//#" + to_string(NewData.Balance);
...

  {
...

    {
      ...
      case enNumberTranstactions::TotalBalance:
        ...
        Action6ShowBalance(ReadInfoFromFile());
